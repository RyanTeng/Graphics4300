...
public interface  IScenegraphRenderer
{
     ...
     * @param shaderVarsToVertexAttribs a map of shader variables -> vertex attributes in each mesh
     *                                  Every mesh added to this renderer must have the required vertex attributes
     * @param shaderProgram
     */

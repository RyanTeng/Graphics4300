 ...
 * This is implemented by the {@link sgraph.AbstractNode} throwing an exception for all such methods, and
...
public interface INode
{
    ...
    /**
     * Sets the texture to be associated with this node. Not all types of nodes can have
     * textures associated with them. If the node cannot have a texture, this methods throws an
